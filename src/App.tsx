...
const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    if (!user && (window.location.hash.startsWith('#/login') || window.location.hash.startsWith('#/public/request'))) {
        return <div className="bg-background min-h-screen text-text-primary">{children}</div>;
    }
